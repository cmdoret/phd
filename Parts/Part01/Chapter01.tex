...
% 2,500 serovars classified based on LPS and flagellar antigens
% includes typhoid and non-typhoid antigens
typhi and paratyphi serovars (typhoid) cause a systemic disease. Human restricted
...
Every year, 1.35 million cases salmonellosis are reported in the United States alone, causing 420 deaths and requiring 27,500 hospitalizations. Most of the current knowledge on \textit{Salmonella} infection biology was built on the typhoidal serovar \textit{S. enterica} subsp. \textit{enterica} serovar Typhi. 

Much like \textit{Legionella}, when \textit{Salmonella} enters the host cell, it is engulfed into a \acrfull{SCV}  and secretes effector proteins into the host cytoplasm. This is done via two independent type 3 secretion systems (T3SS).
